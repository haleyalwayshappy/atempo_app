...
class AnimatedSadImage extends StatefulWidget {
  final String image;
  final double width;
  const AnimatedSadImage({
    super.key,
    required this.image,
    required this.width,
  });
  ...
  @override
  State<AnimatedSadImage> createState() => _AnimatedSadImageState();
}

class _AnimatedSadImageState extends State<AnimatedSadImage>
