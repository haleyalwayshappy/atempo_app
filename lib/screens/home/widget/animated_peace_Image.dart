...
class AnimatedPeaceImage extends StatefulWidget {
  final String image;
  final double width;
  const AnimatedPeaceImage({
    super.key,
    required this.image,
    required this.width,
  });
  ...
  @override
  State<AnimatedPeaceImage> createState() => _AnimatedPeaceImageState();
}

class _AnimatedPeaceImageState extends State<AnimatedPeaceImage>
