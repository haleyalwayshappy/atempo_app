...
class AnimatedConfusedImage extends StatefulWidget {
  final String image;
  final double width;
  const AnimatedConfusedImage({
    super.key,
    required this.image,
    required this.width,
  });
  ...
  @override
  State<AnimatedConfusedImage> createState() => _AnimatedConfusedImageState();
}

class _AnimatedConfusedImageState extends State<AnimatedConfusedImage>
